...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Btnorder_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strconn;
            strconn = ConfigurationManager.ConnectionStrings["furniture"].ToString();
            ...
            cmd2.CommandText = "insert into orderproducts values(@orderid,@productid,@productname,@productimgurl,@quantity,@price)";
