...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string connString = ConfigurationManager.ConnectionStrings["furniture"].ToString();//external Sql server 2008
        ...
        objConn.Open();
        SqlCommand objCmd = new SqlCommand("select * from categoryproduct where productid=@productid", objConn);
